...
class TestCreateAd():
    def test_create_ad_non_auth_user(self, driver:WebDriver, wait):
        ...
        assert driver.find_element(*AuthorizationPageLocators.HEADER_POPUP_AUTH).text == Config.POPUP_TEXT
    ...
    def test_create_ad_auth_user(self, driver:WebDriver, wait, create_random_description, create_random_price, go_to_authorization_page):
        ...
        driver.find_element(*AdvertismentPageLocators.NAME).send_keys(Config.NAME_AD)
        ...
        assert driver.find_element(*AdvertismentPageLocators.ADVERTISMENT).text == Config.NAME_AD
